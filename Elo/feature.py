# -*- coding: utf-8 -*-
"""
Created on Fri Jan 18 15:11:20 2019
...
def deal_data():
    # baseline只做了new_merchant，中categorical类型数据的映射部分。
...
def feature_new_merchants_amountx(data):
    ...
    for col in cols:
        ...
        t = t.rename(
            columns={'sum': 'sum_purchase_amount', 'mean': 'mean_purchase_amount', 'max': 'max_purchase_amount', \
...
if __name__ == '__main__':
    ...
    feature_new_merchants_category123(
        data_new_merchant_transactions[['card_id', 'category_1', 'category_2', 'category_3']])
